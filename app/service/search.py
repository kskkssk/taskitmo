    ...
    first_response = client.chat.completions.create(
        ...
        messages = [
            ...
            },
            {
                "role": "user",
                "content":
                    "В вопросе есть варианты ответа. Напиши мне ответ в формате json. Где в ключе answer ты напишешь числовое значение - вариант правильного ответа. Если нет вариантов ответов (числа), пиши null. В ключе reasoning  ты напишешь объяснение или дополнительную информацию по запросу (например откуда ты узнал эту информацию) и что ответ дан моделью gpt-4o-mini. В ключе sources ты напишешь список ссылок на источники информации."
                    f"Вот запрос: {query}"
            }
        ],
